...
// GitHub's own profile READMEs mix markdown with raw HTML (a centering
...
export default function ProfileReadme({ initialMarkdown }: { initialMarkdown: string | null }) {
  ...
  async function save(e: React.FormEvent) {
    ...
    try {
      ...
      setMarkdown(data.readme.markdown);
